...
public partial class AdminFeedback : System.Web.UI.Page
{
    ...
    {
        if (DropDownList2.SelectedValue.ToString() == "All Questions")
        {
            Q1.Visible = true;
            Q2.Visible = true;
            Q3.Visible = true;
        }
        if (DropDownList2.SelectedValue.ToString() == "Question 1")
        {
            Q1.Visible = true;
            Q2.Visible = false;
            Q3.Visible = false;
        }
        if (DropDownList2.SelectedValue.ToString() == "Question 2")
        {
            Q1.Visible = false;
            Q2.Visible = true;
            Q3.Visible = false;
        }
        if (DropDownList2.SelectedValue.ToString() == "Question 3")
        {
            Q1.Visible = false;
            Q2.Visible = false;
            Q3.Visible = true;
    ...
    private void all()
    {
        string review = "SELECT * from Feedback order by Id DESC";
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        ...
        if (from != "" || to != "")
        {
            string review = "SELECT * from Feedback where Date between @date1 and @date2 order by Id DESC";
            SqlConnection conn = new SqlConnection(lines);
            SqlCommand cmd = new SqlCommand(review, conn);
            conn.Open();

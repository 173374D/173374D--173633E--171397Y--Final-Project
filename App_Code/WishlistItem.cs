...
using System.Data;
    ...
    public decimal TotalPrice
        ...
        public WishlistItem(string productID, Product prod)
        {
            this.ItemID = productID;
        ...
        public WishlistItem(string productID, string productName, string productDesc, decimal productPrice,string productImage,int stock)
        {
            this.ItemID = productID;
        ...
        public bool Equals(WishlistItem anItem)
        {
            return anItem.ItemID == this.ItemID;
        }

        //public bool Equals(WishlistItem product)
        //{

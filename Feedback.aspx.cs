...
public partial class Feedback : System.Web.UI.Page
{
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string ins = "Insert into [Feedback](Name, Q1, Q2, Q3, Date, Rating) values('" + txt_name.Text + "','" + txt_Q1.Text + "','" + txt_Q2.Text + "','" + txt_Q3.Text + "','" + CurrentTime + "','" + RadioButtonList1.SelectedValue.ToString() + "')";
            SqlConnection con = new SqlConnection(lines);
            SqlCommand com = new SqlCommand(ins, con);
            con.Open();
            int check = com.ExecuteNonQuery();
            con.Close();
            ClientScript.RegisterStartupScript(this.GetType(), "alert", "alert('Thank you for your informative responses.')", true);
        }
        catch
        {

...
public partial class ViewCart : System.Web.UI.Page
{
    ...
    protected void gv_CartView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        Wishlist.Instance.RemoveItem(productId);
        LoadCart();
    }

    protected void LoadCart()
    {
        //bind the Items inside the Session/Wishlist Instance with the Datagrid
        DataList1.DataSource = Wishlist.Instance.Items;
        DataList1.DataBind();
    }
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        ...
        {
            Wishlist.Instance.RemoveItem(e.CommandArgument.ToString());
            LoadCart();
        }
